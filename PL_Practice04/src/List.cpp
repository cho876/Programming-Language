...
Node::Node(Entry s)   // String -> Entry 수정
{  
   data = s;
   previous = NULL;
   next = NULL;
...
void List::push_front(Entry s)   // String -> Entry 수정
{
   Node* newnode = new Node(s);
   if (last == NULL) /* list is empty */
   {
...
void List::insert(Iterator iter, Entry s)   // String -> Entry 수정
{  
...
Entry Iterator::get() const   // String -> Entry 수정
{  
...
Entry Iterator::operator*() const   // String -> Entry 수정
{
   assert(position != NULL);
   return position->data;
}
Entry& Iterator::operator*()   // String -> Entry 수정
{
   assert(position != NULL);
   return position->data;
}
